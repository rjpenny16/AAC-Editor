...
description: >
  ...
  accent, the three-step gray text ladder, Archivo for display and body,
...
colors:
  ...
  accent-medium: "rgba(0, 113, 227, 0.15)"
  border: "rgba(0, 113, 227, 0.2)"
  card-bg: "rgba(0, 113, 227, 0.04)"
  positive: "#248A3D"
  negative: "#D70015"
...
typography:
  # — reading ramp (Archivo body + chrome) —
...
- **Fonts** — already set to **Archivo** for display and body; ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **SF Pro Display** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **SF Pro Display** (body, muted gray, line 1.6). Headlines are near-black;
...
- **SF Pro Display** (display/numerals/chrome) + **SF Pro Display** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (SF Pro Display body 0.85cqw muted; SF Pro Display eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (SF Pro Display `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body SF Pro Display 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line SF Pro Display `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + SF Pro Display label + muted desc + optional
...
blockquote, cite. **Focal** a SF Pro Display `blockquote` near-black under a 15%-opacity cobalt
...
SF Pro Display body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a SF Pro Display `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body SF Pro Display 400 muted, line 1.6.
...
- **Type** — SF Pro Display headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; SF Pro Display body muted line 1.6; ≥1.4cqw floor.
...
- **SF Pro Display + SF Pro Display via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
